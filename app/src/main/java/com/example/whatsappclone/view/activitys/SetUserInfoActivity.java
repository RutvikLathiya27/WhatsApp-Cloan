...
import com.example.whatsappclone.databinding.ActivitySetUserInfoBinding;
...
public class SetUserInfoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //check user new or old
        firebaseUser = FirebaseAuth.getInstance().getCurrentUser();
        db = FirebaseFirestore.getInstance();

        Log.d("Rutvik Lathiya", "User ID:" + firebaseUser.getUid());
...
//                    Glide.with(SetUserInfoActivity.this).load(task.getResult().getString("imageUrl")).into(binding.imageProfile);
    ...
    private void initButttonClick() {

        binding.btnNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (TextUtils.isEmpty(binding.edName.getText().toString())) {
                    Toast.makeText(SetUserInfoActivity.this, "Please enter username...", Toast.LENGTH_SHORT).show();
                } else {
                    uploadToFirebase();
                }
            }
...
//            uploadToFirebase();
    ...
    private void uploadToFirebase() {
        if (imageUri != null) {
            ...
            StorageReference mountainsRef = FirebaseStorage.getInstance().getReference().child("ImagesProfile/" + System.currentTimeMillis() + "." + getFileExtention(imageUri));
